...
const About = () => {
  return (
    <div className="about-container">
      <h1>About Us</h1>
      <p>
        Welcome to [Startup Name], where innovation meets passion for sports and
        ...
        the upcoming Paris 2024 Summer Olympics. At [Startup Name], we believe
      ...
      <p>
        ...
        doorstep, [Startup Name] has you covered.
      </p>
      <p>
      ...
      <p>
        At [Startup Name], we're more than just a technology company — we're a
      ...
      <p className="last-paragraph">
        Join us at [Startup Name], and let's make history together.
      </p>
    </div>
  );
};
